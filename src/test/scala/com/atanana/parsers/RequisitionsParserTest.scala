  ...
  "RequisitionsParser" should {
    "parse valid data" in {
      ...
      RequisitionsParserImpl().getRequisitionsData(html) shouldEqual Success(List(
        PartialRequisitionData("Асинхрон «Это не ноготочки»", TournamentId(9082), "Красковский Дмитрий Дмитриевич", LocalDateTime.of(2023, 4, 10, 20, 0)),
        PartialRequisitionData("Лига Сибири. VI тур (синхрон)", TournamentId(8308), "Штукатер Дмитрий Сергеевич", LocalDateTime.of(2023, 4, 11, 19, 0))
      ))
    }
