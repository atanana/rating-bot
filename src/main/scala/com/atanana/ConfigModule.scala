...
import com.atanana.parsers.{CsvParser, ReleasesParser, RequisitionsPageParser, RequisitionsParser, TeamsPageParser, TeamsPageParserImpl, TournamentInfoParser, TournamentPageParser, TournamentPageParserImpl}
